...
void ResolutionAnalysisTChain(const std::vector<TString>& inputFiles = inputFilesArray){
  // Set output file for the histograms
  TFile *ofile = TFile::Open("DatasetsFromCampaign/ResolutionBGReco.root","RECREATE");
